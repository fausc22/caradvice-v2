...
/**
 * Footer: Trustindex, logo, descripción, teléfono WhatsApp, sucursales (links Maps), redes, copyright.
  ...
  return (
    <>
      ...
      <footer className="bg-[var(--brand-black)] text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 py-8 lg:grid-cols-[auto_1fr_1fr] lg:gap-10 lg:py-10">
            ...
            <div className="flex flex-col justify-start">
              <p className="text-sm leading-relaxed text-white sm:text-base">
                Somos una concesionaria de autos que combina la venta de
                vehículos con asesoría personalizada en cada etapa del proceso.
                Nos especializamos en la compra-venta de autos usados y 0Km,
